...
Supervertaler for Trados uses the same SQLite-based termbase format (`.db`) as Supervertaler Workbench. Termbases created in either tool are fully compatible — you can open the same `.db` file in both applications.
